...
#endif
static const char *ng0 = "C:/Users/ASUS.PIESC/Desktop/logicLab/4-1/xnor1/xnor_sop.v";
...
LAB40:    t228 = (t219 + 4);
    ...
    t231 = (~(t230));
    *((unsigned int *)t219) = t231;
    *((unsigned int *)t228) = 0;
    if (*((unsigned int *)t229) != 0)
        goto LAB42;

LAB41:    t236 = *((unsigned int *)t219);
    *((unsigned int *)t219) = (t236 & 1U);
...
LAB49:    t279 = (t270 + 4);
    ...
    t282 = (~(t281));
    *((unsigned int *)t270) = t282;
    *((unsigned int *)t279) = 0;
    if (*((unsigned int *)t280) != 0)
        goto LAB51;

LAB50:    t287 = *((unsigned int *)t270);
    *((unsigned int *)t270) = (t287 & 1U);
...
LAB42:    t232 = *((unsigned int *)t219);
    t233 = *((unsigned int *)t229);
    *((unsigned int *)t219) = (t232 | t233);
...
extern void work_m_00000000003464018164_2060478369_init()
{
	static char *pe[] = {(void *)Cont_28_0};
	xsi_register_didat("work_m_00000000003464018164_2060478369", "isim/xnor_sop_isim_beh.exe.sim/work/m_00000000003464018164_2060478369.didat");
